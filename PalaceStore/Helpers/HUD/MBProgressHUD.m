...
- (void)layoutSubviews {
    ...
    if (nil != self.labelText) {
        ...
        label.textAlignment = UIBaselineAdjustmentAlignCenters;//UITextAlignmentCenter;
        label.opaque = NO;
        ...
        if (nil != self.detailsLabelText) {
            ...
            detailsLabel.textAlignment = UIBaselineAdjustmentAlignCenters;//UITextAlignmentCenter;
